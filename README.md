...
*για την τελική βαθμολόγηση θα πρέπει να συμπληρωθεί η βάση στην εργασία ανάπτυξης και στην εργασία συμμετοχικό περιεχόμενο. Οι υπολοιπές εργασίες συνυπολογίζονται μετα απο αυτο. 
